	...
	return (
		...
		>
			...
			>
				<span>
					Hei, velkommen til{" "}
					<span className="font-bold"> omsorgstjenesten Du & Vi.</span> Du
					og Vi ønsker å bidra til at du får et bedre liv slik at du kan få
					frihet til å leve det livet du selv vil. Vi er her for deg og vil
					bistå deg for at din hverdag skal bli lettere. Ta gjerne{" "}
